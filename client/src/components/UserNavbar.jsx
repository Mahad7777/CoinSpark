...
function Navbar() {
    ...
    return (
        <div className="flex md:flex-row flex-col justify-between mb-[35px] gap-6 pt-3w-full pt-3">
            ...
            {/* Left side links */}
            <div className="flex flex-row justify-start gap-4 py-4 ml-[50px]">
            <Link 
                    to="/" 
            ...
            <Link 
                    to="/submit-request" 
                    className={` hover:text-[#1abc9c] ${activeLink === '/submit-request' ? 'text-[#1abc9c]' : 'text-[#3498db]'}`}
                    onClick={() => handleLinkClick('/submit-request')}
                >
                    Submit Request
            </Link>
            ...
            <Link 
                    to="/profile" 
                    className={` hover:text-[#1abc9c] ${activeLink === '/profile' ? 'text-[#1abc9c]' : 'text-[#3498db]'}`}
